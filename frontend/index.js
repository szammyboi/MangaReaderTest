...
var series = window.location.href.substring(("http://www.chemistry-tutor.com/reader/".length))
var seriesDisplay;
...
async function loadChapterOptions() {
    await axios
        .get('http://www.chemistry-tutor.com/json/' + series)
        .then(response => {
...
async function loadChapter() {
    ...
    axios
        .get('http://www.chemistry-tutor.com/getChapter/' + series + '/' + chapterTitle)
        .then(response => {
...
function sideLoadChapter(i) {
    ...
    axios
        .get('http://www.chemistry-tutor.com/getChapter/' + series + '/' + chapter)
        .then(response => {
